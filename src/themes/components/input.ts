...
export const Input: ComponentStyleConfig = {
   ...
   variants: {
      ...
      arcadium: (props: StyleFunctionProps) => {
         return {
            field: {
               ...
               _placeholder: {
                  color: mode(`${acTextDark}95`, `${acTextWhite}95`)(props),
               },
               bg: mode("#FFFFFF", "#565A78")(props),
               borderRadius: "2px",
      ...
      arcadiumSearchCulb: (props: StyleFunctionProps) => {
         return {
            field: {
               pl: ["40px", "40px", "50px"],
               color: acTextDark,
      ...
      arcadiumInputGererMonClub: (props: StyleFunctionProps) => {
         return {
            field: {
               color: mode(acTextDark, acTextWhite)(props),
